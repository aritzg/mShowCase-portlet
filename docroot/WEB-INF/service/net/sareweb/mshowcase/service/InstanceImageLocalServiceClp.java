 ...
 * @author Aritz Galdos
 */
public class InstanceImageLocalServiceClp implements InstanceImageLocalService {
	public InstanceImageLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addInstanceImageMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addInstanceImage",
				net.sareweb.mshowcase.model.InstanceImage.class);

		_createInstanceImageMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createInstanceImage", long.class);

		_deleteInstanceImageMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteInstanceImage", long.class);

		_deleteInstanceImageMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteInstanceImage",
				net.sareweb.mshowcase.model.InstanceImage.class);
	...
	public net.sareweb.mshowcase.model.InstanceImage addInstanceImage(
		...
		MethodHandler methodHandler = new MethodHandler(_addInstanceImageMethodKey0,
	...
	public net.sareweb.mshowcase.model.InstanceImage createInstanceImage(
		...
		MethodHandler methodHandler = new MethodHandler(_createInstanceImageMethodKey1,
				InstanceImageId);
	...
	public void deleteInstanceImage(long InstanceImageId)
		...
		MethodHandler methodHandler = new MethodHandler(_deleteInstanceImageMethodKey2,
				InstanceImageId);
	...
	public void deleteInstanceImage(
		net.sareweb.mshowcase.model.InstanceImage instanceImage)
		throws com.liferay.portal.kernel.exception.SystemException {
		MethodHandler methodHandler = new MethodHandler(_deleteInstanceImageMethodKey3,
				ClpSerializer.translateInput(instanceImage));
	...
	public java.util.List<net.sareweb.mshowcase.model.InstanceImage> getInstanceImages(
		...
		return (java.util.List<net.sareweb.mshowcase.model.InstanceImage>)ClpSerializer.translateOutput(returnObj);
	}
	...
	private MethodKey _addInstanceImageMethodKey0;
	private MethodKey _createInstanceImageMethodKey1;
	private MethodKey _deleteInstanceImageMethodKey2;
	private MethodKey _deleteInstanceImageMethodKey3;
