...
public class CategoryLocalServiceClp implements CategoryLocalService {
	public CategoryLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addCategoryMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addCategory", net.sareweb.mshowcase.model.Category.class);

		_createCategoryMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createCategory", long.class);

		_deleteCategoryMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteCategory", long.class);

		_deleteCategoryMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteCategory", net.sareweb.mshowcase.model.Category.class);
	...
	public net.sareweb.mshowcase.model.Category addCategory(
	...
	public net.sareweb.mshowcase.model.Category createCategory(long categoryId) {
		Object returnObj = null;

		MethodHandler methodHandler = new MethodHandler(_createCategoryMethodKey1,
				categoryId);
	...
	public void deleteCategory(long categoryId)
		...
		MethodHandler methodHandler = new MethodHandler(_deleteCategoryMethodKey2,
				categoryId);
	...
	public void deleteCategory(net.sareweb.mshowcase.model.Category category)
		throws com.liferay.portal.kernel.exception.SystemException {
		MethodHandler methodHandler = new MethodHandler(_deleteCategoryMethodKey3,
				ClpSerializer.translateInput(category));
	...
	public java.util.List<net.sareweb.mshowcase.model.Category> getCategories(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		Object returnObj = null;
		...
		return (java.util.List<net.sareweb.mshowcase.model.Category>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public net.sareweb.mshowcase.model.Category updateCategory(
		net.sareweb.mshowcase.model.Category category)
		throws com.liferay.portal.kernel.exception.SystemException {
		Object returnObj = null;
	...
	public java.util.List<net.sareweb.mshowcase.model.Category> findCategoryByParentCategoryId(
	...
	private MethodKey _createCategoryMethodKey1;
	private MethodKey _deleteCategoryMethodKey2;
	private MethodKey _deleteCategoryMethodKey3;
