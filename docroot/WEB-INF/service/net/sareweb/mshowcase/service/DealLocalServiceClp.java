 ...
 * @author Aritz Galdos
 */
public class DealLocalServiceClp implements DealLocalService {
	public DealLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addDealMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addDeal", net.sareweb.mshowcase.model.Deal.class);

		_createDealMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createDeal", long.class);

		_deleteDealMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteDeal", long.class);

		_deleteDealMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteDeal", net.sareweb.mshowcase.model.Deal.class);
	...
	public net.sareweb.mshowcase.model.Deal addDeal(
		...
		MethodHandler methodHandler = new MethodHandler(_addDealMethodKey0,
	...
	public net.sareweb.mshowcase.model.Deal createDeal(long dealId) {
		...
		MethodHandler methodHandler = new MethodHandler(_createDealMethodKey1,
				dealId);
	...
	public void deleteDeal(long dealId)
		...
		MethodHandler methodHandler = new MethodHandler(_deleteDealMethodKey2,
				dealId);
	...
	public void deleteDeal(net.sareweb.mshowcase.model.Deal deal)
		throws com.liferay.portal.kernel.exception.SystemException {
		MethodHandler methodHandler = new MethodHandler(_deleteDealMethodKey3,
				ClpSerializer.translateInput(deal));
	...
	private MethodKey _addDealMethodKey0;
	private MethodKey _createDealMethodKey1;
	private MethodKey _deleteDealMethodKey2;
	private MethodKey _deleteDealMethodKey3;
