...
/**
 * The utility for the activity local service. This utility wraps {@link net.sareweb.mshowcase.service.impl.ActivityLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class ActivityLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link net.sareweb.mshowcase.service.impl.ActivityLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static net.sareweb.mshowcase.model.Activity addActivity(
	...
	*/
	public static net.sareweb.mshowcase.model.Activity createActivity(
		long activityId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static net.sareweb.mshowcase.model.Activity getActivity(
		long activityId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<net.sareweb.mshowcase.model.Activity> getActivities(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static net.sareweb.mshowcase.model.Activity updateActivity(
		net.sareweb.mshowcase.model.Activity activity)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	public static net.sareweb.mshowcase.model.Activity updateActivity(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateActivity(activity, merge);
	}
	...
	public static ActivityLocalService getService() {
		if (_service == null) {
			...
			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					ActivityLocalService.class.getName(), portletClassLoader);

			_service = new ActivityLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(ActivityLocalServiceUtil.class,
				"_service");
			MethodCache.remove(ActivityLocalService.class);
		}
