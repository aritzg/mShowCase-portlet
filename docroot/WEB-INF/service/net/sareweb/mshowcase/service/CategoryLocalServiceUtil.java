...
/**
 * The utility for the category local service. This utility wraps {@link net.sareweb.mshowcase.service.impl.CategoryLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see net.sareweb.mshowcase.service.impl.CategoryLocalServiceImpl
 * @generated
 */
public class CategoryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link net.sareweb.mshowcase.service.impl.CategoryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static net.sareweb.mshowcase.model.Category addCategory(
	...
	*/
	public static net.sareweb.mshowcase.model.Category createCategory(
		long categoryId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static net.sareweb.mshowcase.model.Category getCategory(
		long categoryId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<net.sareweb.mshowcase.model.Category> getCategories(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static net.sareweb.mshowcase.model.Category updateCategory(
		net.sareweb.mshowcase.model.Category category)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static java.util.List<net.sareweb.mshowcase.model.Category> findCategoryByParentCategoryId(
		long parentCategoryId) {
		return getService().findCategoryByParentCategoryId(parentCategoryId);
	}
	...
	public static CategoryLocalService getService() {
		if (_service == null) {
			...
			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					CategoryLocalService.class.getName(), portletClassLoader);

			_service = new CategoryLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(CategoryLocalServiceUtil.class,
				"_service");
			MethodCache.remove(CategoryLocalService.class);
		}
