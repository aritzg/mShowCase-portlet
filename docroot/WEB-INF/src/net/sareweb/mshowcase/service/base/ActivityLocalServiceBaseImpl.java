...
/**
 * The base implementation of the activity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.mshowcase.service.impl.ActivityLocalServiceImpl}.
 * </p>
 *
 * @author Aritz Galdos
...
public abstract class ActivityLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.mshowcase.service.ActivityLocalServiceUtil} to access the activity local service.
	 */
	...
	public Activity addActivity(Activity activity) throws SystemException {
		...
		activity = activityPersistence.update(activity, false);
	...
	public void deleteActivity(long activityId)
		...
		Activity activity = activityPersistence.remove(activityId);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteActivity(Activity activity) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Activity updateActivity(Activity activity, boolean merge)
		throws SystemException {
		activity.setNew(false);

		activity = activityPersistence.update(activity, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("net.sareweb.mshowcase.model.Activity",
			activityLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"net.sareweb.mshowcase.model.Activity");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(ActivityLocalServiceBaseImpl.class);
