...
/**
 * The base implementation of the instance image local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.mshowcase.service.impl.InstanceImageLocalServiceImpl}.
 * </p>
 *
 * @author Aritz Galdos
 ...
 * @generated
 */
public abstract class InstanceImageLocalServiceBaseImpl
	implements InstanceImageLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.mshowcase.service.InstanceImageLocalServiceUtil} to access the instance image local service.
	 */
	 ...
	 */
	public InstanceImage addInstanceImage(InstanceImage instanceImage)
		throws SystemException {
		instanceImage.setNew(true);

		instanceImage = instanceImagePersistence.update(instanceImage, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(instanceImage);
			}
	 ...
	 */
	public InstanceImage createInstanceImage(long InstanceImageId) {
		return instanceImagePersistence.create(InstanceImageId);
	}
	...
	public void deleteInstanceImage(long InstanceImageId)
		...
		InstanceImage instanceImage = instanceImagePersistence.remove(InstanceImageId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(instanceImage);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteInstanceImage(InstanceImage instanceImage)
		throws SystemException {
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return instanceImagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public InstanceImage getInstanceImage(long InstanceImageId)
		throws PortalException, SystemException {
		return instanceImagePersistence.findByPrimaryKey(InstanceImageId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return instanceImagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<InstanceImage> getInstanceImages(int start, int end)
		throws SystemException {
		return instanceImagePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getInstanceImagesCount() throws SystemException {
		return instanceImagePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public InstanceImage updateInstanceImage(InstanceImage instanceImage)
		throws SystemException {
		return updateInstanceImage(instanceImage, true);
	}
	...
	public InstanceImage updateInstanceImage(InstanceImage instanceImage,
		...
		instanceImage = instanceImagePersistence.update(instanceImage, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("net.sareweb.mshowcase.model.InstanceImage",
			instanceImageLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"net.sareweb.mshowcase.model.InstanceImage");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = instanceImagePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(InstanceImageLocalServiceBaseImpl.class);
