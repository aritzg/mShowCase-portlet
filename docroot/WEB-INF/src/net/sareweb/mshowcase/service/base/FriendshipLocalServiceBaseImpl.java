...
/**
 * The base implementation of the friendship local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.mshowcase.service.impl.FriendshipLocalServiceImpl}.
 * </p>
 *
 * @author Aritz Galdos
 ...
 * @generated
 */
public abstract class FriendshipLocalServiceBaseImpl
	implements FriendshipLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.mshowcase.service.FriendshipLocalServiceUtil} to access the friendship local service.
	 */
	...
	public Friendship addFriendship(Friendship friendship)
		...
		friendship = friendshipPersistence.update(friendship, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(friendship);
			}
	 ...
	 */
	public Friendship createFriendship(long friendshipId) {
		return friendshipPersistence.create(friendshipId);
	}
	...
	public void deleteFriendship(long friendshipId)
		...
		Friendship friendship = friendshipPersistence.remove(friendshipId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(friendship);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return friendshipPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return friendshipPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public Friendship getFriendship(long friendshipId)
		throws PortalException, SystemException {
		return friendshipPersistence.findByPrimaryKey(friendshipId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return friendshipPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Friendship> getFriendships(int start, int end)
		throws SystemException {
		return friendshipPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFriendshipsCount() throws SystemException {
		return friendshipPersistence.countAll();
	}
	...
	public Friendship updateFriendship(Friendship friendship)
		throws SystemException {
		return updateFriendship(friendship, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Friendship updateFriendship(Friendship friendship, boolean merge)
		throws SystemException {
		friendship.setNew(false);

		friendship = friendshipPersistence.update(friendship, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("net.sareweb.mshowcase.model.Friendship",
			friendshipLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"net.sareweb.mshowcase.model.Friendship");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = friendshipPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(FriendshipLocalServiceBaseImpl.class);
