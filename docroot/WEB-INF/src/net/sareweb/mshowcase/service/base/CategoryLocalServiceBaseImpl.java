 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.mshowcase.service.impl.CategoryLocalServiceImpl}.
 * </p>
 *
 * @author Aritz Galdos
...
public abstract class CategoryLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.mshowcase.service.CategoryLocalServiceUtil} to access the category local service.
	 */
	...
	public Category updateCategory(Category category, boolean merge)
		...
		category = categoryPersistence.update(category, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("net.sareweb.mshowcase.model.Category",
			categoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"net.sareweb.mshowcase.model.Category");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(CategoryLocalServiceBaseImpl.class);
