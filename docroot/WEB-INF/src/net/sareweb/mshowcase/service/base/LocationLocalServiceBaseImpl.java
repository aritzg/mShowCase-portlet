...
/**
 * The base implementation of the location local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.mshowcase.service.impl.LocationLocalServiceImpl}.
 * </p>
 *
 * @author Aritz Galdos
...
public abstract class LocationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.mshowcase.service.LocationLocalServiceUtil} to access the location local service.
	 */
	...
	public Location addLocation(Location location) throws SystemException {
		...
		location = locationPersistence.update(location, false);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteLocation(Location location) throws SystemException {
	...
	public Location updateLocation(Location location) throws SystemException {
		return updateLocation(location, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Location updateLocation(Location location, boolean merge)
		throws SystemException {
		location.setNew(false);

		location = locationPersistence.update(location, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("net.sareweb.mshowcase.model.Location",
			locationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"net.sareweb.mshowcase.model.Location");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(LocationLocalServiceBaseImpl.class);
